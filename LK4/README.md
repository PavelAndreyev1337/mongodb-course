...
**1. Індекси за одним полем (Прості індекси)**
...
За замовчуванням структура індексу — B-tree, що забезпечує швидкий пошук з логарифмічною складністю. Існують різні типи індексів, адаптовані для різних сценаріїв: за одним полем, композитні, унікальні, TTL, часткові, геопросторові і текстові.
